...
django-cotton-bootstrap is developed with:
...
type: ::
    ...
    git clone https://github.com/sveetch/django-cotton-bootstrap.git
    cd django-cotton-bootstrap
    make install

django-cotton-bootstrap will be installed in editable mode from the
